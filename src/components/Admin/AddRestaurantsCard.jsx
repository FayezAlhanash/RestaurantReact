        ...
        >
            <div className="flex h-full flex-col justify-between rounded-[20px] border border-white/10 bg-[#172124] p-5">
                <div className="flex items-center justify-between gap-3">
                    <div className="grid h-12 w-12 place-items-center rounded-xl bg-[linear-gradient(135deg,#DC2626_0%,#B91C1C_52%,#991B1B_100%)] text-white shadow-[0_12px_24px_rgba(185,28,28,0.26)] transition group-hover:scale-110">
                        <Plus size={22} />
                    </div>
                ...
                <div className="my-10 grid place-items-center">
                    <div className="relative grid h-32 w-32 place-items-center rounded-[28px] border border-white/10 bg-[#0D1214] text-[#EF4444] shadow-inner ring-1 ring-white/[0.04]">
                        <Store size={44} />
